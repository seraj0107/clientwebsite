...
const SectionForm2 = () => {
    ...
    const defaultData = {
        ...
        backgroundColor: "#ffffff",
        textColor: "#1f2937",
        // Add all the missing properties that your form uses
        companyName: "",
        primaryColor: "#3b82f6",
        ...
        // Add nested objects with their properties
        whoWeAreContent: {
            gautamSolarLink: "",
            paragraph1: "",
            paragraph2: "",
    ...
    useEffect(() => {
        if (websiteData.section2) {
            setFormData({
                ...defaultData,
                ...websiteData.section2,
            });
        }
    }, [websiteData.section2]);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const result = saveSectionData("section2", formData);
                ...
                <section className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            type="url"
                            value={
                                formData.whoWeAreContent?.gautamSolarLink || ""
                            }
                            onChange={(e) =>
                                handleNestedChange(
                                    "whoWeAreContent",
                    ...
                    {/* Repeat for other fields that might be undefined */}
