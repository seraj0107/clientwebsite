...
const SectionForm1 = () => {
    ...
    // Load from context
    useEffect(() => {
        if (websiteData.section1) {
            setFormData({
                ...defaultData,
                ...websiteData.section1,
            });
            setImagePreviews({
                logo: websiteData.section1.logo || "",
                bgimg: websiteData.section1.bgimg || "",
            });
        }
    }, [websiteData.section1]);
    ...
    const handleImageUpload = (e, imageKey) => {
        ...
        handleChange(imageKey, imageUrl);
    };
    ...
    const handleSubmit = async () => {
        ...
        try {
            const result = saveSectionData("section1", formData);
