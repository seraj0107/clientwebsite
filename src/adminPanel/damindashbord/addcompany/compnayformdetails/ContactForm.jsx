...
const ContactForm = () => {
    ...
    useEffect(() => {
        if (websiteData.contact) {
            ...
            setImagePreviews({
                logo: websiteData.contact.logo || "",
                bgimg4: websiteData.contact.bgimg4 || "",
            });
        }
    }, [websiteData.contact]);
    ...
    const handleSubmit = async () => {
        ...
        try {
            const result = saveSectionData("contact", formData);
    ...
    return (
        <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-lg">
            ...
            <div className="p-6 space-y-8">
                        ...
                        {saveStatus === "success" ? (
                            <>
                                ...
                                <div>
                                    ...
                                    <p className="text-sm">
                                        Contact saved locally. Click "Publish
                ...
                {/* Preview Section */}
                {showPreview && (
                    <div className="bg-gray-50 p-6 rounded-lg border-2 border-dashed border-gray-300 max-h-[600px] overflow-y-auto">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="text-lg font-semibold">
                                Live Preview
                            </h3>
                        ...
                        >
                            ...
                            <div className="p-4 border border-gray-300 rounded-2xl">
                                <div className="flex items-center justify-between">
                                    {imagePreviews.logo ? (
                                        ...
                                        <div className="h-10 w-32 bg-gray-300 rounded flex items-center justify-center text-gray-500 text-sm">
                                            Logo Here
                                        </div>
                                    )}
                                    <div
                            ...
                            <div
                                ...
                                style={{
                                    backgroundImage: imagePreviews.bgimg4
                                        ? `url(${imagePreviews.bgimg4})`
                                        : `linear-gradient(135deg, ${formData.gradientFrom}, ${formData.gradientTo})`,
                                    backgroundSize: "cover",
                                    backgroundPosition: "center",
                                }}
                            >
                                <div className="p-8 text-center bg-black/30 backdrop-blur-sm">
                                    <h1
                                        className="text-3xl md:text-4xl font-bold mb-4"
                                        style={{ color: "white" }}
                                    >
                                        {formData.contactSection.heading}
                                    </h1>
                                    <p
                                        className="text-lg mb-6 opacity-90"
                                        style={{ color: "white" }}
                                    >
                                        {formData.contactSection.subheading}
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                {getContactInfo().map((info, index) => (
                                    <div
                                        key={index}
                                        className="border border-gray-300 rounded-2xl p-6 text-center hover:shadow-lg transition-shadow"
                            ...
                            {/* CTA Section */}
                            <div
                                className="p-8 rounded-3xl text-center border border-gray-300"
                                style={{
                                    background: `linear-gradient(135deg, ${formData.gradientFrom}20, ${formData.gradientTo}20)`,
                                }}
                            >
                                <h2
                                    ...
                                    style={{ color: formData.textColor }}
                                >
                                    {formData.contactSection.ctaHeading}
                                </h2>
                                <p
                                    className="mb-6 max-w-2xl mx-auto"
                                    style={{ color: formData.textColor }}
                                >
                                    {formData.contactSection.ctaDescription}
                                </p>
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <a
                                        href={`tel:${formData.phone}`}
                                        className="px-6 py-3 rounded-lg font-bold text-white flex items-center justify-center gap-2 transition shadow-lg"
                                        style={{
                                            background: `linear-gradient(to right, ${formData.gradientFrom}, ${formData.gradientTo})`,
                                        }}
                                    >
                                        <FaPhoneAlt />
                                        {formData.contactSection.ctaButtonText}
                                    </a>
                                    <a
                                        href={`mailto:${formData.email}`}
                                        className="px-6 py-3 rounded-lg font-bold border-2 transition flex items-center justify-center gap-2"
                                        style={{
                            ...
                            <div className="border border-gray-300 rounded-2xl overflow-hidden">
                                <div
                                    ...
                                    style={{
                                        ...
                                        backgroundImage: `repeating-linear-gradient(45deg, transparent, transparent 10px, ${formData.primaryColor}15 10px, ${formData.primaryColor}15 20px)`,
                                    }}
                                >
                            ...
                            <div
                                ...
                                style={{
                                    backgroundColor: `${formData.primaryColor}05`,
                                }}
                            >
                                <div className="flex flex-col md:flex-row justify-between items-center">
                                    <div className="mb-4 md:mb-0">
                                        ...
                                        >
                                            ...
                                            {formData.companyName}. All rights
                                            reserved.
                                        </p>
                                    </div>
                            ...
                            <div className="flex gap-3 items-center">
                                {imagePreviews.logo && (
                                    <img
                                        src={imagePreviews.logo}
                                        alt="Logo Preview"
                                        className="w-16 h-16 rounded object-contain border-2 border-gray-300"
                                    />
                                )}
